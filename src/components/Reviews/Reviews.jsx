...
function Reviews() {
  ...
  return (
    <>
      <Filters sortParam={sortParam} SetCategoryName={SetCategoryName} SetCategories={SetCategories} categories={categories} categoryName={categoryName} SetOrderParam={SetOrderParam} SetSortParam={SetSortParam} />
      <h2 id="allReviewsHeader">{categoryName ? `'${capitaliseCategoryName(categoryName)}'` : 'All'} reviews</h2>
